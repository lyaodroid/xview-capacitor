...
import { FileSelectorPlugin, FileSelectorOptions } from "./definitions";

export class FileSelectorWeb
    extends WebPlugin
    implements FileSelectorPlugin {
    fileSelector(options: FileSelectorOptions): Promise<any> {
        var x: HTMLInputElement = <HTMLInputElement>(
